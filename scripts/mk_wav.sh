...
do
    ...
    /home/smg/takaki/SRC/straight/bin/synthesis_fft -f 48000 -spec -fftl 4096 -shift 5 -sigp 1.2 -cornf 4000 -float -apfile $dir/$base.ap $spec_dir/$base.f0.a $spec_dir/$base.spec.unwarp.f8 $spec_dir/$base.wav
done